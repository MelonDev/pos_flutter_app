          ...
          child: Container(
            ...
            child: ListView.builder(
                ...
                itemBuilder: (context, position) {
                        ...
                        children: [
                          ...
                          Container(
                            width: ((MediaQuery.of(context).size.width - 60) /
                                ...
                                4,
                            child: Text(
                              "${widget.item.value.cart[position - 9].product.price}",
                              textAlign: TextAlign.right,
                              style: GoogleFonts.itim(
                                  fontWeight: FontWeight.normal,
                                  fontSize: 20,
                          ...
                          Container(
                            width: ((MediaQuery.of(context).size.width - 60) /
                                ...
                                5,
                            child: Text(
                              "${(widget.item.value.cart[position - 9].amount * double.parse(widget.item.value.cart[position - 9].product.price)).toStringAsFixed(2)}",
                              textAlign: TextAlign.right,
                              style: GoogleFonts.itim(
                                  fontWeight: FontWeight.normal,
                                  fontSize: 20,
                  ...
                  } else if (position == 10 + widget.item.value.cart.length) {
                    return Container(
                  ...
                  } else if (position == 11 + widget.item.value.cart.length) {
                    return Container(
                      margin: EdgeInsets.only(top: 40, left: 20, right: 20),
                      child: Stack(
                        children: [
